...
makeTest('commonjs-style-deps');
makeTest('commonjs-style-sideeffect');
makeTest('static-in-call-expression');
...
exports['test logical name'] = function (test) {
    test.equal(amdToEs6(readFile('logical-name'), {logicalName: true, beautify: true}), readFile('logical-name-expected'));
    test.done();
};
